...
# 产品线（用于 Release 标题）：SecureCRT/SecureFX 共享 9.x 版本号同一 Release，VShell 独立 5.x/4.x
case "$PRODUCT" in
    securecrt|securefx|bundle) SUITE="SecureCRT & SecureFX" ;;
    vshell)                    SUITE="VShell" ;;
    *)                         SUITE="VanDyke" ;;
esac
echo "✅ 版本: ${VERSION} → Tag: ${TAG} | 产品线: ${SUITE}"
